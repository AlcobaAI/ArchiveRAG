...
class IP3Scraper(Scraper):
    ...
    def get_data(self, url):
        ...
        for link in pdf_links:
            ...
            os.makedirs('ip3', exist_ok=True)
            if filename in os.listdir('ip3'):
                continue
            
            save_path = f'ip3/{filename}'
        ...
        new_urls = ['ip3/' + a['href'] if 'http' not in a['href'] and 'ip3/' not in a['href'] else a['href'] for a in new_urls]
