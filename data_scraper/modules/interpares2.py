...
class IP2Scraper(Scraper):
    ...
    def get_data(self, url):
        ...
        for link in pdf_links:
            ...
            if filename in os.listdir('ip2'):
                continue
            
            save_path = f'ip2/{filename}'
        ...
        new_urls = ['ip2/' + a['href'] if 'http' not in a['href'] and 'ip2/' not in a['href'] else a['href'] for a in new_urls]
